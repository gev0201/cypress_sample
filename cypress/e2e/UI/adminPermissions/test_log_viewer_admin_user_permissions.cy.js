...
describe('test suite implemented to test log viewer admin user permissions', () => {
    let userData, links;
    before('login and create admin user with only log viewer role', () => {
        cy.fixture('AdminUsers/LogViewer').then((fixtureData) => {
    ...
    beforeEach('login with Log Viewer user', () => {
        cy.login(userData.username, userData.password);
    });

    it('test case implemented to login as admin user with only log viewer role and verify correct menu items are displayed', () => {
