...
describe('test suite implemented to test trigger manager admin user permissions', () => {
    let userData, links;
    before('login and create admin user with only trigger manager role', () => {
        cy.fixture('AdminUsers/TriggerManager').then((fixtureData) => {
    ...
    beforeEach('login with Trigger Manager user', () => {
        cy.login(userData.username, userData.password);
    });

    it('test case implemented to login as admin user with only trigger manager role and verify correct menu items are displayed', () => {
