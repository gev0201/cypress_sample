...
describe('test suite implemented to test secure mail manager admin user permissions', () => {
    let userData, links;
    before('login and create admin user with only secure mail manager role', () => {
        cy.fixture('AdminUsers/SecureMailManager').then((fixtureData) => {
    ...
    beforeEach('login with Secure Mail Manager user', () => {
        cy.login(userData.username, userData.password);
    });

    it('test case implemented to login as admin user with only secure mail manager role and verify correct menu items are displayed', () => {
