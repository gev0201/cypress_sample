...
describe('test suite implemented to test secure forms manager admin user permissions', () => {
    let userData, links;
    before('login and create admin user with only secure forms manager role', () => {
        cy.fixture('AdminUsers/SecureFormsManager').then((fixtureData) => {
    ...
    beforeEach('login with Secure Forms Manager user', () => {
        cy.login(userData.username, userData.password);
    })

    it('test case implemented to login as admin user with only secure forms manager role and verify correct menu items are displayed', () => {
