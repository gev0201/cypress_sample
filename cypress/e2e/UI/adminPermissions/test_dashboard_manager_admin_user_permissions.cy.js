...
describe('test suite implemented to test dashboard manager admin user permissions', () => {
    let userData, links;
    before('login and create admin user with only dashboard manager role', () => {
        cy.fixture('AdminUsers/DashboardManager').then((fixtureData) => {
    ...
    beforeEach('login with Dashboard Manager user', () => {
        cy.login(userData.username, userData.password);
    });

    it('test case implemented to login as admin user with only dashboard manager role and verify correct menu items are displayed', () => {
