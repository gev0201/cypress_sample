...
describe('test suite implemented to test sla manager admin user permissions', () => {
    let userData, links;
    before('login and create admin user with only sla manager role', () => {
        cy.fixture('AdminUsers/SLAManager').then((fixtureData) => {
    ...
    beforeEach('login with SLA Manager user', () => {
        cy.login(userData.username, userData.password);
    });

    it('test case implemented to login as admin user with only sla manager role and verify correct menu items are displayed', () => {
